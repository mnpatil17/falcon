...
def specialize_arr_arr_element_wise(func):
    """
    ...
    return LazyElemWiseArrayArrayOp.from_function(func, "ElemArrayArrayOp" + func_name_capital)
...
class ConcreteElemWiseArrayArrayOp(ConcreteSpecializedFunction):
    """
...
class LazyElemWiseArrayArrayOp(LazySpecializedFunction):
    """
